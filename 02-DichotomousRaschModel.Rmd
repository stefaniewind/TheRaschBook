...
![Iteration Information](screenshots/Cha2_Iteration.png)


[Cheng - can we add a screenshot here?]
[Dr.Wind, the tam() result do not include item estimates. The item parameters shows up when you call summary() function]
[Cheng - okay, please delete this screenshot. sorry about that.]

![TAM Result](screenshots/Cha2_TAM.png)
...
[Cheng - can we add a screenshot here?]
![Item Parameters](screenshots/Cha2_ItemParameters.png)
...
[Cheng - can we add a screenshot here with an arrow pointing to the central panel of the Wright map?]
[Dr.Wind, If you want to divide the previous Map for a better illustration, I can also do that.]
...
![View Item Difficulty](screenshots/Cha2_ViewDiff.png)
...
### Summarize the results from the JMLE dichotomous Rasch model analysis
...
Dr. Wind, the chuck for calculating the Person/Item Separation Reliability is sepearte from the Main codes. Could you put the following chunck into approriate palce that you think?
...
Andrich, David. "An Index of Person Separation in Latent Trait Theory, the Traditional KR-20 Index, and the Guttman Scale Response Pattern." *Education Research and Perspectives*, 9, 95–104.

Bonifay, Wes. *Multidimensional item response theory*(1st ed.). Sage, 2019.

Briggs, Derek and Mark Wilson. "An Introduction to Multidimensional Measurement using Rasch Models." *Journal of Applied Measurement*, 4(1),2003, 87–100.

Cronbach, Lee Joseph. "Coefficient alpha and the internal structure of tests." *Psychometrika*, 16(3),1995, 297–334. https://doi.org/10.1007/BF02310555

Linacre, ‪John Michael.  *A user’s guide to WINSTEPS MINISTEP Rasch-model computer programs* V.3.83.4 [Computer software]. winsteps.com. 2020a, http://www.winsteps.com/manuals.htm

Linacre, ‪John Michae. *A user’s guide to WINSTEPS MINISTEP Rasch-model computer programs* V. 4.7.0 [Computer software], 2020b, winsteps.com. 

Reckase, Mark D. *Multidimensional Item Response Theory*(1st ed.). Springer,2009.

Wilson, Mark. Some Notes on the Term: “Wright Map.” *Rasch Measurement Transactions*, 25(3),2003, 1331.
